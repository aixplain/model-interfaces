...
from docs.user.samples.metric.chrf.src.model import CHRF

INPUTS_PATH="docs/user/samples/metric/chrf/tests/inputs.json"
OUTPUTS_PATH="docs/user/samples/metric/chrf/tests/outputs.json"
...
def test_chrf(inputs, outputs, testcase):
    metric = "chrf"
    scorer = CHRF()
...
def test_chrf_aggregation(inputs, outputs):
    scorer = CHRF()
    metric = 'chrf'
    results = []
