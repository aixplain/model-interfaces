...
import os
from docs.user.samples.metric.meteor.src.model import Meteor


INPUTS_PATH="docs/user/samples/metric/meteor/tests/inputs.json"
OUTPUTS_PATH="docs/user/samples/metric/meteor/tests/outputs.json"
...
def test_meteor(inputs, outputs, testcase, scorer):
...
def test_meteor_aggregation(inputs, scorer):
    metric = 'meteor'
    results = []
