...
from docs.user.samples.metric.confusion_matrix.src.model import ConfusionMatrix

INPUTS_PATH="docs/user/samples/metric/confusion_matrix/tests/inputs.json"
OUTPUTS_PATH="docs/user/samples/metric/confusion_matrix/tests/outputs.json"
...
def test_confusion_matrix(inputs, outputs):
